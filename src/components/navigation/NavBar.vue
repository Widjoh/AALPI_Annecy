<template>
  <div class="flex flex-col ">
    <div
        class="bg-white flex  h-10 sm:justify-between w-[100%] items-center px-6 sm:px-32 py-10 fixed top-0 z-40">
    ...
    <div v-if="displayMenu"
         class="z-40 sm:hidden bg-white fixed top-20 drop-shadow-sm duration-500 transition-all transition-shadow	shadow-2xl w-full flex flex-col p-6 space-y-4"
