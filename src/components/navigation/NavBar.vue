<template>
  <div class="flex flex-col">
    <div class="bg-white flex drop-shadow-md  h-10 sm:justify-between w-[100%] items-center px-6 sm:px-32 py-10 fixed top-0">
    ...
    <div v-if="displayMenu" class="bg-white fixed top-20 drop-shadow-md	 duration-500 transition-all transition-shadow	shadow-2xl w-full flex flex-col p-6 space-y-4" :class="{ 'hidden': !displayMenu }">
      <div v-for="link in links" :key="link.path">
